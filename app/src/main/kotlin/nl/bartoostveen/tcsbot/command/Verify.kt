    ...
    (event.channel as? TextChannel)?.sendMessage(MessageCreate {
      embeds += Embed(
        ...
        description = """
          ...
          https://git.bartoostveen.nl/bart/tcs-bot (or send a DM to @huizengek ([@bart:bartoostveen.nl on Matrix](https://matrix.to/#/@bart:bartoostveen.nl)) / an email to [tcsbot@bartoostveen.nl](mailto:tcsbot@bartoostveen.nl))
        """.trimIndent(),
